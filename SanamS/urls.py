...
urlpatterns = [
    ...
    url(r'^events/(?P<event_id>[\d]+)$','Sanam.views.event'),
    url(r'^tickettype/(?P<tick_id>[\d]+)$','Sanam.views.editTicketType'),
    ...
    url(r'^category/edit/(?P<category_id>[\d]+)$', 'Sanam.views.editCategory'),
    ...
    url(r'^Profiles', 'Sanam.views.profile'),
